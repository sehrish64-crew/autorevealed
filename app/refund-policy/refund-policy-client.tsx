      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="mt-10 space-y-8 max-w-3xl mx-auto text-gray-700">
          ...
          <section>
            ...
            <p className="mt-3">These Terms and Conditions ("Agreement") form a legally binding contract between you ("Buyer", "you", or "your"), <strong>Merchant</strong> (as defined below), and <strong>Allied Timber</strong> ("Supplier", "we", "our", or "us") and govern your use of the services provided via <strong>AutoRevealed.com</strong>.</p>
