...
### 1️⃣ **Step 1: User Fills Get Report Form**
   ...
   - **What Happens:** 
     ...
     - ✉️ **Email sent to:** `autorevealed.com@gmail.com`
...
#### 📧 **Email #1 - Customer Order Confirmation**
   - **Sent to:** `autorevealed.com@gmail.com` (customer's email)
   - **From:** `autorevealed.com@gmail.com`
   - **Content:**
     - Order ID
     - Amount paid
     - Package details
...
#### 📧 **Email #2 - Admin Payment Notification**
   - **Sent to:** `autorevealed.com@gmail.com` (admin)
   - **From:** `autorevealed.com@gmail.com`
   - **Content:**
     - Customer email
     - Order details
...
| **SMTP Port** | `587` |
| **SMTP User** | `autorevealed.com@gmail.com` |
| **Email From** | `AutoRevealed <autorevealed.com@gmail.com>` |
| **Admin Email** | `autorevealed.com@gmail.com` |
...
5. ✅ Check if you received the form submission email at `autorevealed.com@gmail.com`
...
```
To: user@example.com
Subject: Payment Confirmed - AutoRevealed Order #ORD-123456
